...
<div class="flex min-h-screen bg-gray-100">
    ...
    <aside class="w-64 bg-white shadow-lg p-5 hidden md:block">
        ...
        <nav class="space-y-3">
            <a href="{{ route('dashboard',['view'=>'home']) }}" class="block px-4 py-2 rounded bg-blue-100 text-blue-600">Dashboard</a>
            <a href="{{ route('dashboard',['view'=>'campaigns']) }}" class="block px-4 py-2 rounded hover:bg-gray-100">Campagnes</a>
            <a href="{{ route('dashboard',['view'=>'donations']) }}" class="block px-4 py-2 rounded hover:bg-gray-100">Dons</a>
            <a href="{{ route('dashboard',['view'=>'notifications']) }}" class="block px-4 py-2 rounded hover:bg-gray-100">Notifications</a>
            <a href="{{ route('dashboard',['view'=>'create']) }}" class="block px-4 py-2 rounded hover:bg-gray-100">Créer</a>
        </nav>
    </aside>
        ...
        <div class="bg-white p-6 rounded-xl shadow">
            ...
            <div class="border p-4 rounded mb-4">
                ...
                <div class="flex gap-2 mt-3">
                    <a href="{{ route('dashboard',['view'=>'edit','id'=>$c->id]) }}" class="bg-yellow-400 px-3 py-1 rounded text-white">Edit</a>
